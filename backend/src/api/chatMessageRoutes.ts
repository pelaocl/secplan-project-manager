...
router.post(
    ...
    validateRequest({ params: taskIdSchema, body: createChatMessageSchema }),
...
router.get(
    '/:taskId/messages',
    authenticateToken,
    validateRequest({ params: taskIdSchema, query: getChatMessagesSchema }), // Valida los query params de paginación
